...
// 2026-06-09 TASK-4.3 引入：Web Push 通知设置
import { PushNotificationSettings } from '@shared/push'
// 2026-06-09 TASK-4.4 引入：协作设置（登录/工作区/配对）
import CollaborationSettings from './components/CollaborationSettings.vue'
...
const sidebarItems: SidebarItem[] = [
  ...
  { key: 'collab', label: '协作', icon: 'cluster-o' },  // 2026-06-09 TASK-4.4 引入
  { key: 'system', label: '系统', icon: 'info-o' },
  { key: 'push', label: '推送通知', icon: 'volume-o' },  // 2026-06-09 TASK-4.3 引入
  ...
  <div class="settings-view" :class="{ mobile: isMobile }">
    <template v-if="isDesktop">
      ...
      <div class="content">
        ...
        <!-- 2026-06-09 TASK-4.3 引入：Web Push 推送通知设置 -->
        <div v-if="activeSection === 'push'" class="section">
          <PushNotificationSettings />
        </div>

        <!-- 2026-06-09 TASK-4.4 引入：协作（登录/工作区/配对） -->
        <div v-if="activeSection === 'collab'" class="section">
          <h3 class="section-title">协作</h3>
