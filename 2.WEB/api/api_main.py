...
_routes_modules = [
    ...
    "routes.push",  # 2026-06-09 TASK-4.3 引入：Web Push 通知
    "routes.auth",  # 2026-06-09 TASK-4.4 引入：JWT + 多用户鉴权
    "routes.yjs",   # 2026-06-09 TASK-4.4 引入：Y.js 实时协作 WS
    "routes.skill_market",  # 2026-06-09 TASK-4.5 引入：技能市场
    "routes.model_router",  # 2026-06-09 TASK-4.6 引入：智能模型路由
    "routes.git",           # 2026-06-10 TASK-2.2 引入：Git DiffView 增强
    "routes.dictation",     # 2026-06-10 TASK-2.5 引入：语音听写
]
