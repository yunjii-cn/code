...
// 2026-06-10 TASK-2.8 引入：useToast 增强版（替代 window.confirm）
import { useToast as useToastEnhanced } from '../composables/useToast'
...
// 2026-06-10 TASK-2.8 引入：toast 增强版
...
function handleClear() {
  ...
  // 2026-06-10 TASK-2.8：替换 window.confirm 为 useToast 增强版 action
  toast.show({
    type: 'warning',
    message: `清空全部 ${total.value} 条通知？`,
    detail: '此操作不可撤销',
    duration: 0,
    position: 'top',
    action: {
